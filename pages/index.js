...
function Index({ Component, pageProps }) {
  ...
  let abi = [
      ...
      inputs: [
        {
          ...
          name: "nft_minting_start_date_chosen",
          type: "uint256",
        },
        {
          internalType: "uint256",
          name: "nft_minting_end_date_chosen",
          type: "uint256",
        },
      ],
    ...
    },
    {
      inputs: [
        {
          internalType: "address",
          name: "addressToGrantRole",
          type: "address",
        },
      ],
      name: "grantDefaultAdminRole",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
    },
    ...
    {
      inputs: [],
      name: "nft_minting_current_count",
      outputs: [
        {
          internalType: "uint8",
          name: "",
  ...
  let contractAddress = "0x67Eaa8ac36feeaE6c72CAD6AA5E046F32C0F5A9A";
